...
--
-- Host: localhost
-- Generation Time: Jan 24, 2023 at 01:28 PM
...
--
-- Database: `research_trends_challenges`
--
CREATE DATABASE IF NOT EXISTS `research_trends_challenges` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `research_trends_challenges`;
...
('7ghqea9u7k2m0f1v435cwmbtpzegmudu', 'eyJ1c2VyaWQiOjJ9:1pKJHV:2GXUOBTHVs7j-N6ti53RR8Rc8TSeGj6Cg-3leYCSDVU', '2023-02-07 13:24:09.185313'),
...
('wkhmbxtirgy6afk53846mk8yh91247sf', 'eyJ1c2VyaWQiOjF9:1pKIDW:Zwn1ANyBaldbGGtmb_wqpQONyYgbL8WDuSDeXfdfNvU', '2023-02-07 12:15:59.004662'),
...
(1, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyber_attack_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyber_attack_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `urlid` varchar(300) NOT NULL,
  `URL` varchar(300) NOT NULL,
  `Source_IP` varchar(300) NOT NULL,
  `Source_Port` varchar(300) NOT NULL,
  `Destination_IP` varchar(300) NOT NULL,
  `Destination_Port` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_cyber_attack_detection`
--

INSERT INTO `remote_user_cyber_attack_detection` (`id`, `urlid`, `URL`, `Source_IP`, `Source_Port`, `Destination_IP`, `Destination_Port`, `Timestamp`, `Prediction`) VALUES
(1, '10.42.0.211-10.42.0.1-47717-53-17', 'vinoscalyptra.cl/paypal/paypal/update/com/c53b375e47339f779a68088c7d648f89/wbsccr.php?cmd=_Processing&amp;dispatchX85d80a13c0db1fb6947b0aeae66fdbfb2119927117e3a6f876e0fd34af4365aea49e3373cbf7bc336d49d99e495a6caea49e3373cbf7bc336d49d99e495a6c', '10.42.0.211', '55284', '123.125.29.220', '80', '2022-09-27T20:06:25', 'Cyber Attack'),
(2, '172.217.12.136-10.42.0.151-443-36812-6', '0358e9c.netsolhost.com/?check=8ivTVMAcMkheQpTLVrD8L0.html', '10.42.0.211', '58273', '174.35.73.77', '80', '2022-09-27T15:26:17', 'Cyber Attack'),
(3, '10.42.0.211-52.31.6.40-46596-443-6', 'brotherpeacemaker.wordpress.com/2007/12/21/willow-smiths-role-model-is-paris-hilton/', '104.244.43.131', '443', '10.42.0.151', '49741', '2022-06-29T23:03:52', 'No Cyber Attack'),
(4, '172.217.7.2-10.42.0.211-443-48580-6', 'mahadmanpower.com/panel-my-account-configeration-all-limited/panel-my-account-configeration-all-limited/nirvana.php?cmd=_login-run', '10.42.0.151', '62834', '10.42.0.1', '53', '2022-09-27T10:44:58', 'Cyber Attack');
...
(17, 'SVM', '99.41383352872217'),
(18, 'Logistic Regression', '98.8862837045721'),
(19, 'Decision Tree Classifier', '99.00351699882766'),
(20, 'KNeighborsClassifier', '97.30363423212192'),
(21, 'SGD Classifier', '99.41383352872217');
...
(16, 'No Cyber Attack', '25.0'),
(17, 'Cyber Attack', '75.0');
