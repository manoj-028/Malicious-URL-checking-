...
def Predict_Cyber_Attack_Status(request):
    if request.method == "POST":
        ...
        return render(request, 'RUser/Predict_Cyber_Attack_Status.html',{'objs': val})
    return render(request, 'RUser/Predict_Cyber_Attack_Status.html')
